    ...
    <div className="flex flex-col md:flex-row justify-between w-full mt-5 xl:pt-0 md:mt-0 sm:pt-16">
      <div className="md:ml-16 md:pr-5 m-auto text-center">
        ...
        <div className="flex flex-col md:flex-row mt-8 w-full">
          <button className="bg-gradient-to-r from-blue-300 to-blue-400 py-4 px-7 rounded-full text-gray-200 text-xl mt-5 m-auto" onClick={(e) => {e.preventDefault(); window.location.href='Projects';}}>Check Out My Projects</button>
          <button className="bg-gradient-to-r from-blue-300 to-blue-400 py-4 px-7 rounded-full text-gray-200 text-xl mt-5 m-auto" onClick={(e) => {e.preventDefault(); window.location.href='services'}}>Check out My Services</button>
        </div>
