    ...
    <nav className="container mx-auto px-6 md:px-12 py-4">
      <div className="md:flex justify-between items-center">
        ...
        <div className="hidden md:flex md:items-center md:justify-end space-x-4">
          <a href="/" className="px-3 py-2 transition ease-in duration-200 uppercase hover:text-gray-700 text-gray-400 focus:outline-none">
            Home
          </a>
          <a href="Services" className="px-3 py-2 transition ease-in duration-200 uppercase hover:text-gray-700 text-gray-400 focus:outline-none">
            Services
          </a>
        </div>
      </div>
  ...
  <div className="container mx-auto h-screen pt-32 md:pt-0 px-6 z-10 flex items-center justify-between">
    <div className="container mx-auto px-6 flex flex-col-reverse lg:flex-row justify-between items-center relative">
      <div className="w-full mb-16 md:mb-8 text-center lg:text-left">
        <h1 className="font-semibold font-sans text-center lg:text-left text-5xl lg:text-8xl mt-12 md:mt-0 text-gray-700">
          Sorry, this page isn't available
        </h1>
        <button className="px-2 py-2 w-96 mt-16 font-semibold transition ease-in duration-200 hover:bg-blue-400 text-lg rounded-lg bg-blue-300 focus:outline-none" onClick={(e) => {e.preventDefault(); window.location.href='/';}}>
          Go back home
        </button>
      </div>
